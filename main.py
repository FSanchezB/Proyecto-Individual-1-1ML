import pandas as pd
import numpy as np
df=pd.read_csv(r'data procesada para funciones/movies_procesado')
df_directores=pd.read_csv(r'data procesada para funciones/directores_procesado')
df_actores=pd.read_csv(r'data procesada para funciones/actores_procesado')
df_ml=pd.read_csv(r'data procesada para funciones/data_funcion_recomendacion')
